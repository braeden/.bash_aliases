...
alias update='sudo apt-get update && sudo apt-get install -f && sudo apt-get autoremove && sudo apt-get clean && sudo apt-get autoclean && sudo apt-get upgrade && sudo rpi-update && sudo reboot'
alias space='df -h'
alias status='htop'
